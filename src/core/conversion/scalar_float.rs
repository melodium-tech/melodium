...
impl_ScalarFloat!(f32_to_f64, "ScalarF32ToF64", F32, recv_f32, F64, f64, send_multiple_f64);
impl_ScalarFloat!(f64_to_f32, "ScalarF64ToF32", F64, recv_f64, F32, f32, send_multiple_f32);

...
#[mel_function]
pub fn equal(a: i8, b: i8) -> bool {
    a == b
}

/// Return whether `a` is different `b`
#[mel_function]
pub fn not_equal(a: i8, b: i8) -> bool {
    a != b
}
...
#[mel_function]
pub fn ge(a: i8, b: i8) -> bool {
    a >= b
}

/// Tells whether `a` is lower or equal to `b`.
#[mel_function]
pub fn le(a: i8, b: i8) -> bool {
    a <= b
}
...
#[mel_function]
pub fn div(dividend: i8, divisor: i8) -> i8 {
    dividend / divisor
}
...
#[mel_function]
pub fn rem(dividend: i8, divisor: i8) -> i8 {
    dividend % divisor
}

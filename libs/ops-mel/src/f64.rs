...
pub async fn cbrt() {
    while let Ok(values) = value.recv_f64().await {
        check!(root.send_f64(values.into_iter().map(|v| v.cbrt()).collect()).await)
    }
}
...
pub async fn ln() {
    while let Ok(values) = value.recv_f64().await {
        check!(log.send_f64(values.into_iter().map(|v| v.ln()).collect()).await)
    }
}
...
pub async fn sqrt() {
    while let Ok(values) = value.recv_f64().await {
        check!(root.send_f64(values.into_iter().map(|v| v.sqrt()).collect()).await)
    }
}
...
pub async fn acos() {
    while let Ok(values) = value.recv_f64().await {
        check!(acos.send_f64(values.into_iter().map(|v| v.acos()).collect()).await)
    }
}
...
pub async fn acosh() {
    while let Ok(values) = value.recv_f64().await {
        check!(acosh.send_f64(values.into_iter().map(|v| v.acosh()).collect()).await)
    }
}
...
pub async fn asin() {
    while let Ok(values) = value.recv_f64().await {
        check!(asin.send_f64(values.into_iter().map(|v| v.asin()).collect()).await)
    }
}
...
pub async fn asinh() {
    while let Ok(values) = value.recv_f64().await {
        check!(asinh.send_f64(values.into_iter().map(|v| v.asinh()).collect()).await)
    }
}
...
pub async fn atan() {
    while let Ok(values) = value.recv_f64().await {
        check!(atan.send_f64(values.into_iter().map(|v| v.atan()).collect()).await)
    }
}
...
pub async fn atanh() {
    while let Ok(values) = value.recv_f64().await {
        check!(atanh.send_f64(values.into_iter().map(|v| v.atanh()).collect()).await)
    }
}
...
pub async fn cos() {
    while let Ok(values) = value.recv_f64().await {
        check!(cos.send_f64(values.into_iter().map(|v| v.cos()).collect()).await)
    }
}
...
pub async fn cosh() {
    while let Ok(values) = value.recv_f64().await {
        check!(cosh.send_f64(values.into_iter().map(|v| v.cosh()).collect()).await)
    }
}
...
pub async fn sin() {
    while let Ok(values) = value.recv_f64().await {
        check!(sin.send_f64(values.into_iter().map(|v| v.sin()).collect()).await)
    }
}
...
pub async fn sinh() {
    while let Ok(values) = value.recv_f64().await {
        check!(sinh.send_f64(values.into_iter().map(|v| v.sinh()).collect()).await)
    }
}
...
pub async fn tan() {
    while let Ok(values) = value.recv_f64().await {
        check!(tan.send_f64(values.into_iter().map(|v| v.tan()).collect()).await)
    }
}
...
pub async fn tanh() {
    while let Ok(values) = value.recv_f64().await {
        check!(tanh.send_f64(values.into_iter().map(|v| v.tanh()).collect()).await)
    }
}
...
pub async fn abs() {
    while let Ok(values) = value.recv_f64().await {
        check!(abs.send_f64(values.into_iter().map(|v| v.abs()).collect()).await)
    }
}

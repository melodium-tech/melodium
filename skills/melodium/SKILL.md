...
- Version strings follow SemVer compatibility rules (Cargo-style): `"0.10.3"` allows `>=0.10.3, <0.11.0`.
- Other operators: `~0.10.3` (patch only), `0.10.*` (wildcard), `>= 0.9, < 0.11` (range).

...
/// Turns `i128` into `Vec<byte>`.
#[mel_function]
pub fn to_byte(value: i128) -> Vec<byte> {
...
/// 
#[mel_function]
pub fn to_u8(value: i128, truncate: bool, or_default: u8) -> u8 {
    if truncate {
        value as u8
    }
    else {
...
/// 
#[mel_function]
pub fn to_u16(value: i128, truncate: bool, or_default: u16) -> u16 {
    if truncate {
        value as u16
    }
    else {
...
/// 
#[mel_function]
pub fn to_u32(value: i128, truncate: bool, or_default: u32) -> u32 {
    if truncate {
        value as u32
    }
    else {
...
/// 
#[mel_function]
pub fn to_u64(value: i128, truncate: bool, or_default: u64) -> u64 {
    if truncate {
        value as u64
    }
    else {
...
/// 
#[mel_function]
pub fn to_u128(value: i128, truncate: bool, or_default: u128) -> u128 {
    if truncate {
        value as u128
    }
    else {
...
/// 
#[mel_function]
pub fn to_i8(value: i128, truncate: bool, or_default: i8) -> i8 {
    if truncate {
        value as i8
    }
    else {
...
/// 
#[mel_function]
pub fn to_i16(value: i128, truncate: bool, or_default: i16) -> i16 {
    if truncate {
        value as i16
    }
    else {
...
/// 
#[mel_function]
pub fn to_i32(value: i128, truncate: bool, or_default: i32) -> i32 {
    if truncate {
        value as i32
    }
    else {
...
/// 
#[mel_function]
pub fn to_i64(value: i128, truncate: bool, or_default: i64) -> i64 {
    if truncate {
        value as i64
    }
    else {
